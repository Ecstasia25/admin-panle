...
export default function MyTeamForm({
  ...
  const formatedUserOptions: MemberOption[] =
    collegeUsers
      ?.filter((collegeUser) => {
  ...
  function onSubmit(values: TeamFormValues) {
    ...
    if (selectedMembersCount > maxGroupSize) {
      // -1 to account for the representative
  ...
  const newChangesMade =
    ...
    form
      .getValues("members")
      .some((member: string) => !teamData?.members.some((m) => m.id === member))
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              ...
              {teamId && (
                <>
                  ...
                  <div className="flex flex-col">
                    <FormLabel>
                      Representative College Name (Not Editable)
                    </FormLabel>
                    <Input
              ...
              {teamId && (
                <div className="col-span-1 md:col-span-2">
                  ...
                  <CopyInput value={teamJoinLink} className="bg-muted mt-1" />
                </div>
              )}
              {teamId && (
                <FormField
