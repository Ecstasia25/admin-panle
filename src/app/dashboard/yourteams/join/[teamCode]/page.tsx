...
const TeamJoinConfirmationPage = ({
  ...
  const enabledCollegeOnly = teamData.collegeOnly

  const checkUserCollegeNameWithTeamCollegeName = enabledCollegeOnly
    ? user?.collegeName === teamData.reap.collegeName
    : true
  // Main render
  return (
    <>
        ...
        <div className="space-y-4">
          ...
          <Card className="mx-auto w-full">
                ...
                <div className="w-full mt-3">
                  <Alert>
                    ...
                    <AlertDescription className="mt-2">
                      ...
                      <span className="font-semibold">
                        College : {teamData?.reap?.collegeName}
                      </span>{" "}
                      can join this team only.
                      <br />
                      <span className="font-semibold">
                        (College Event Representative enabled this feature)
                      </span>
                    </AlertDescription>
                  </Alert>
                </div>
            ...
            <CardContent className="-mt-2">
              ...
              {checkUserCollegeNameWithTeamCollegeName ? (
                ...
                <div className="w-full flex items-center justify-end mt-3">
                  <Button disabled variant={"destructive"}>
                    You are not allowed to join this team
                    <Frown className="size-4 shrink-0 ml-2" />
                  </Button>
                </div>
              )}
            </CardContent>
